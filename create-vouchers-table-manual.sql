-- Create vouchers table manually
...
VALUES ('WELCOME10', 'percentage', 10, 0, 100, true, NOW() + INTERVAL '30 days');

-- Insert another test voucher
INSERT INTO vouchers (code, discount_type, discount_value, min_order_amount, max_uses, is_active, expires_at)
VALUES ('SAVE50', 'fixed', 50, 200, 50, true, NOW() + INTERVAL '7 days');
